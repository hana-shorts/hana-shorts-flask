...
async def connect():
    ...
    g_appkey = 'PS7zc8Gigb7spxYKY70uQdKvutV8ZS1DuvER'
    g_appsceret = '5P1Uw06aGaq1f3u/QLC5E8KfX0vE4bR1xK6zn5BQdbLfZmoiuT3JXseXA8qpmgJbMuucCnzfigkIh1RUjUn3W5gXYT0ExKrEGur1V5fXtDritH86WagMtKTUh37AbT6jOU5ORi2Q6S6syupPmTwW7wCMHLvoZQX3WtC7OvXXR8J2go7s99Y='
    g_personalsecKey = '퍼스널셋키를 입력하세요'    # 법인만 해당
    
    stockcode = '005930'    # 테스트용 임시 종목 설정, 삼성전자
    htsid = 'hwan0317'    # 체결통보용 htsid 입력
