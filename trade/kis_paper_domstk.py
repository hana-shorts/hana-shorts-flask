...
def get_balance_sheet(div_cls_code = "0", div_code="J", itm_no="", tr_cont="", FK100="", NK100="", dataframe=None):  # [국내주식] 기본시세 > NAV 비교추이(종목)
    url = '/uapi/domestic-stock/v1/finance/balance-sheet'
    tr_id = "FHKST66430100"  # NAV 비교추이(종목)
    ...
    current_data = pd.DataFrame(res.getBody().output)  # 현재가  * getBody() kis_auth.py 존재
...
def get_income_statment(div_cls_code = "0", div_code="J", itm_no="", tr_cont="", FK100="", NK100="", dataframe=None):  # [국내주식] 기본시세 > NAV 비교추이(종목)
    url = '/uapi/domestic-stock/v1/finance/income-statement'
    tr_id = "FHKST66430200"  # NAV 비교추이(종목)
...
def get_financial_ratio(div_cls_code = "0", div_code="J", itm_no="", tr_cont="", FK100="", NK100="", dataframe=None):  # [국내주식] 기본시세 > NAV 비교추이(종목)
    url = '/uapi/domestic-stock/v1/finance/financial-ratio'
    tr_id = "FHKST66430300"  # NAV 비교추이(종목)
...
def get_inquire_investor(div_code="J", itm_no="", tr_cont="", FK100="", NK100="", dataframe=None):  # [국내주식] 기본시세 > NAV 비교추이(종목)
    url = '/uapi/domestic-stock/v1/quotations/inquire-investor'
    tr_id = "FHKST01010900 "  # NAV 비교추이(종목)
